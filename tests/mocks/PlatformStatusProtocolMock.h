...
#ifndef WOLKABOUTCONNECTOR_PLATFORMSTATUSPROTOCOLMOCK_H
#define WOLKABOUTCONNECTOR_PLATFORMSTATUSPROTOCOLMOCK_H
...
public:
    ...
    // PlatformStatusProtocol methods
    MOCK_METHOD(std::unique_ptr<PlatformStatusMessage>, parsePlatformStatusMessage, (const std::shared_ptr<Message>&));
};

#endif    // WOLKABOUTCONNECTOR_PLATFORMSTATUSPROTOCOLMOCK_H

...
#ifndef WOLKGATEWAY_GATEWAYSUBDEVICEPROTOCOLMOCK_H
#define WOLKGATEWAY_GATEWAYSUBDEVICEPROTOCOLMOCK_H
...
class GatewaySubdeviceProtocolMock : public GatewaySubdeviceProtocol
{
public:
    // Protocol methods
...
#endif    // WOLKGATEWAY_GATEWAYSUBDEVICEPROTOCOLMOCK_H

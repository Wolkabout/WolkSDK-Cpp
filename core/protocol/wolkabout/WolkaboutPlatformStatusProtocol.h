...
#ifndef WOLKABOUTCORE_WOLKABOUTPLATFORMSTATUSPROTOCOL_H
#define WOLKABOUTCORE_WOLKABOUTPLATFORMSTATUSPROTOCOL_H

#include "core/protocol/PlatformStatusProtocol.h"

namespace wolkabout
{
class WolkaboutPlatformStatusProtocol : public PlatformStatusProtocol
{
public:
...
#endif    // WOLKABOUTCORE_WOLKABOUTPLATFORMSTATUSPROTOCOL_H

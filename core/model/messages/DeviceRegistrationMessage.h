...
namespace wolkabout
{
// This is a collection of information required to register a feed while registering a device.
struct FeedRegistrationData
{
    std::string name;
    FeedType type;
    std::string unit;
...
// This is a collection of information required to register an attribute while registering a device.
struct AttributeRegistrationData
{
    std::string name;
    DataType type;
    std::string value;
...
struct DeviceRegistrationData
{
    ...
    std::map<std::string, FeedRegistrationData> feeds;
    std::map<std::string, AttributeRegistrationData> attributes;
};

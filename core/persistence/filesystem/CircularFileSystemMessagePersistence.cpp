...
#include "core/persistence/filesystem/CircularFileSystemMessagePersistence.h"
...
: FileSystemMessagePersistence(persistPath, method), m_sizeLimitBytes{sizeLimitBytes}
{
    loadFileSize();
}

bool CircularFileSystemMessagePersistence::push(std::shared_ptr<wolkabout::Message> message)
{
...
void CircularFileSystemMessagePersistence::pop()
{
    std::lock_guard<decltype(m_mutex)> guard{m_mutex};
...
void CircularFileSystemMessagePersistence::setSizeLimit(unsigned bytes)
{
...
void CircularFileSystemMessagePersistence::loadFileSize()
{
...
void CircularFileSystemMessagePersistence::checkSizeAndNormalize()
{

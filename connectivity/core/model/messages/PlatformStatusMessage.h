...
/**
 * This is a util method that is used to convert a ConnectivityStatus value into a string value.
 *
...
/**
 * This is a util method that is used to convert a string into a ConnectivityStatus value.
 *
